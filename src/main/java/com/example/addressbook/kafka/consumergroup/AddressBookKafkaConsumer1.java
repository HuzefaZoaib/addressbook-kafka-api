...
@Service
public class AddressBookKafkaConsumer1 extends AddressBookKafkaAbstractConsumer {
	...
	public AddressBookKafkaConsumer1(@Autowired ApplicationContext springApplicationContext) {
