...
@Service
public class AddressBookKafkaConsumer2 extends AddressBookKafkaAbstractConsumer {
	...
	public AddressBookKafkaConsumer2(@Autowired ApplicationContext springApplicationContext) {
